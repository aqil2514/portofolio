...
export function MobileFilter() {
  ...
  return (
    <div className="w-full px-4 mt-4">
      ...
      >
        <AccordionItem value="filter" className="border-none">
          <AccordionTrigger className="px-4 py-3 text-white text-lg font-semibold hover:no-underline">
            Filters
          </AccordionTrigger>
            ...
            >
              ...
              <div className="flex gap-2 pt-2">
                ...
                <UiButton
                  ...
                  label="Reset"
                  onClick={resetFilters}
                  className="flex-1 bg-white/0 hover:bg-white/10 border-white/10 text-white/70"
                />
              </div>
            </form>
          </AccordionContent>
